...
---
title: "Análisis: Medicación en el momento de la operacón"
...
datos_Medicacion <- data[, 59:110]
head(datos_Medicacion)
```
...
datos_Medicacion <- mutate_at(datos_Medicacion, vars(-Tipo_De_Intervencion_Quirurgica), as.numeric)

#
datos_Medicacion = na.omit(datos_Medicacion)
```
...
Pca_data = select(datos_Medicacion, -Tipo_De_Intervencion_Quirurgica)
...
fviz_pca_ind(pca_result,
             ...
             habillage = datos_Medicacion$Tipo_De_Intervencion_Quirurgica, # color by groups
